...
public class Folios implements java.io.Serializable {
	...
	public Folios(int idFolio) {
		this.idFolio = idFolio;
	}

	public Folios(int idFolio, Integer year, Integer enero, Integer febrero, Integer marzo, Integer abril, Integer mayo,
			Integer junio, Integer julio, Integer agosto, Integer septiembre, Integer octubre, Integer noviembre,
			Integer diciembre) {
		this.idFolio = idFolio;
		this.year = year;
		this.enero = enero;
