...
public class ResumenVotatorA  implements Serializable {
    ...
    public ResumenVotatorA() {
    }

	
    public ResumenVotatorA(int idResumen) {
        this.idResumen = idResumen;
    }
    public ResumenVotatorA(int idResumen, FolioPreparacionVotatorA folioPreparacionVotatorA, String noOperacion, Date fechaInicio, Date horaInicio, Date fechaFinal, Date horaFinal, Integer tiempo) {
       this.idResumen = idResumen;
