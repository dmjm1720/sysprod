...
public class EsterilizadorPlantaB implements java.io.Serializable {
	...
	public EsterilizadorPlantaB(int idEsterilizdor) {
		this.idEsterilizdor = idEsterilizdor;
	}

	public EsterilizadorPlantaB(int idEsterilizdor, FolioPreparacionEstB folioPreparacionEstB, String hora,
