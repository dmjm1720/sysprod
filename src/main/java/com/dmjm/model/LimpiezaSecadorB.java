...
public class LimpiezaSecadorB implements java.io.Serializable {

	private static final long serialVersionUID = 1L;
	private int idLimpiezaSecadorB;
	...
	public LimpiezaSecadorB() {
	}

	public LimpiezaSecadorB(int idLimpiezaSecadorB) {
		this.idLimpiezaSecadorB = idLimpiezaSecadorB;
	}

	public LimpiezaSecadorB(int idLimpiezaSecadorB, FolioPreparacionSecadorB folioPreparacionSecadorB, Date horaInicial,
	...
	public int getIdLimpiezaSecadorB() {
		return this.idLimpiezaSecadorB;
	}

	public void setIdLimpiezaSecadorB(int idLimpiezaSecadorB) {
		this.idLimpiezaSecadorB = idLimpiezaSecadorB;
	}
