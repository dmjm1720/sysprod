...
public class EntradasImportacion implements Serializable {
	...
	public EntradasImportacion(int idEntradaImportacion, CuentasContables cuentasContables, Materia materia,
			...
			Integer porcentaje, Long folioImportacion,BigDecimal humedad,BigDecimal calcios, int estadoImpresion) {
		this.idEntradaImportacion = idEntradaImportacion;
