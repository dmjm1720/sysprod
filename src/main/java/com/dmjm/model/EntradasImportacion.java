...
public class EntradasImportacion  implements java.io.Serializable {
    ...
    public EntradasImportacion(int idEntradaImportacion, CuentasContables cuentasContables, Materia materia, ProveedoresImportacion proveedoresImportacion, BigDecimal tolva, Date fechaEntrada, String ticketEmbarque, String factura, BigDecimal kgEmbarcado, BigDecimal kgToluca, BigDecimal kgNeto, BigDecimal kgMerma, BigDecimal kgPatio, Integer folioEa, Integer porcentajeSalado, Integer certificadoZoosanitario, Integer porcentaje) {
       this.idEntradaImportacion = idEntradaImportacion;
    ...
    public BigDecimal getTolva() {
        return this.tolva;
    }
    
    public void setTolva(BigDecimal tolva) {
        this.tolva = tolva;
    }
