...
public class DafUno implements java.io.Serializable {
	...
	public DafUno(int idDaf) {
		this.idDaf = idDaf;
	}

	public DafUno(int idDaf, FolioPreparacionDafUno folioPreparacionDafUno, String hora, String operacion,
			...
			Boolean estadoLimpieza, Integer folioPreparacion) {
		this.idDaf = idDaf;
