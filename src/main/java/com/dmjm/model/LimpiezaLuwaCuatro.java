...
public class LimpiezaLuwaCuatro  implements java.io.Serializable {


	private static final long serialVersionUID = 1L;
	private int idLimpiezaLuwaCuatro;
    ...
    public LimpiezaLuwaCuatro() {
    }

	
    public LimpiezaLuwaCuatro(int idLimpiezaLuwaCuatro) {
        this.idLimpiezaLuwaCuatro = idLimpiezaLuwaCuatro;
    }
    public LimpiezaLuwaCuatro(int idLimpiezaLuwaCuatro, FolioPreparacionLuwaCuatro folioPreparacionLuwaCuatro, Date horaInicial, Date horaFinal, String quimico, BigDecimal litrosUsados, String um, Integer temperatura, String lote, BigDecimal phFinal, String proceso, Integer noLimpieza, String vobo, String noLuwa, Integer idUsuario) {
       this.idLimpiezaLuwaCuatro = idLimpiezaLuwaCuatro;
    ...
    public int getIdLimpiezaLuwaCuatro() {
        return this.idLimpiezaLuwaCuatro;
    }
    
    public void setIdLimpiezaLuwaCuatro(int idLimpiezaLuwaCuatro) {
        this.idLimpiezaLuwaCuatro = idLimpiezaLuwaCuatro;
    }
