...
public class LimitesEspecificosA implements java.io.Serializable {
	...
	public LimitesEspecificosA() {
	}

	public LimitesEspecificosA(int idLimite) {
		this.idLimite = idLimite;
	}

	public LimitesEspecificosA(int idLimite, Integer folioLm, Date fecha, String limiteUno, String limiteDos,
