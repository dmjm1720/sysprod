...
public class VotatorB implements Serializable {
	...
	public VotatorB(int idVotator) {
		this.idVotator = idVotator;
	}

	public VotatorB(int idVotator, FolioPreparacionVotatorB folioPreparacionVotatorB, String hora, String operacion,
