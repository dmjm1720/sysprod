...
public class LuwaTres implements java.io.Serializable {
	...
	public LuwaTres(int idLuwa) {
		this.idLuwa = idLuwa;
	}

	public LuwaTres(int idLuwa, FolioPreparacionLuwaTres folioPreparacionLuwaTres, String hora, String operacion,
