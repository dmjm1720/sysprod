...
public class LuwaCuatro implements java.io.Serializable {
	...
	public LuwaCuatro(int idLuwa) {
		this.idLuwa = idLuwa;
	}

	public LuwaCuatro(int idLuwa, FolioPreparacionLuwaCuatro folioPreparacionLuwaCuatro, String hora, String operacion,
