...
public class ResumenLuwaTres implements java.io.Serializable {
	...
	public ResumenLuwaTres() {
	}

	public ResumenLuwaTres(int idResumen) {
		this.idResumen = idResumen;
	}

	public ResumenLuwaTres(int idResumen, FolioPreparacionLuwaTres folioPreparacionLuwaTres, String noOperacion,
