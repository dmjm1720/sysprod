...
public class LimpiezaLuwaCinco implements java.io.Serializable {

	private static final long serialVersionUID = 1L;
	private int idLimpiezaLuwaCinco;
	...
	public LimpiezaLuwaCinco() {
	}

	public LimpiezaLuwaCinco(int idLimpiezaLuwaCinco) {
		this.idLimpiezaLuwaCinco = idLimpiezaLuwaCinco;
	}

	public LimpiezaLuwaCinco(int idLimpiezaLuwaCinco, FolioPreparacionLuwaCinco folioPreparacionLuwaCinco,
			Date horaInicial, Date horaFinal, String quimico, BigDecimal litrosUsados, String um, Integer temperatura,
			String lote, BigDecimal phFinal, String proceso, Integer noLimpieza, String vobo, String noLuwa,
			Integer idUsuario) {
		this.idLimpiezaLuwaCinco = idLimpiezaLuwaCinco;
	...
	public int getIdLimpiezaLuwaCinco() {
		return this.idLimpiezaLuwaCinco;
	}

	public void setIdLimpiezaLuwaCinco(int idLimpiezaLuwaCinco) {
		this.idLimpiezaLuwaCinco = idLimpiezaLuwaCinco;
	}
