...
public class LimitesReferenciaA  implements java.io.Serializable {
    ...
    public LimitesReferenciaA() {
    }

	
    public LimitesReferenciaA(int idLimite) {
        this.idLimite = idLimite;
    }
    public LimitesReferenciaA(int idLimite, Integer folioLr, Date fecha, String presionVapor, String velTapete) {
       this.idLimite = idLimite;
