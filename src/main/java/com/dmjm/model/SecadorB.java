...
public class SecadorB implements java.io.Serializable {
	...
	public SecadorB(int idSecador) {
		this.idSecador = idSecador;
	}

	public SecadorB(int idSecador, FolioPreparacionSecadorB folioPreparacionSecadorB, String hora, String operacion,
