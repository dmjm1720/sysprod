...
public interface ILuwaDosDao {

	List<LuwaDos> listaLuwa();

	List<LuwaDos> listaFiltroLuwa();

	List<LuwaDos> listaPorFechaLuwa(Date fecha);

	void guardarLuwa(LuwaDos luwa);

	void actualizarLuwa(LuwaDos luwa);
