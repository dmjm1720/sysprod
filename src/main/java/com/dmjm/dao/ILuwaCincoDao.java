...
public interface ILuwaCincoDao {

	List<LuwaCinco> listaLuwa();

	List<LuwaCinco> listaFiltroLuwa();

	List<LuwaCinco> listaPorFechaLuwa(Date fecha);

	void guardarLuwa(LuwaCinco luwa);

	void actualizarLuwa(LuwaCinco luwa);
