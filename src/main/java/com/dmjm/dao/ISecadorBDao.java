...
public interface ISecadorBDao {

	List<SecadorB> listaSecador();

	List<SecadorB> listaFiltroSecador();

	List<SecadorB> listaPorFechaSecador(Date fecha);

	void guardarSecador(SecadorB secador);

	void actualizarSecador(SecadorB secador);
