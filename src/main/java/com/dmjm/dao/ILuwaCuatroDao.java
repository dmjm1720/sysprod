...
public interface ILuwaCuatroDao {

	List<LuwaCuatro> listaLuwa();

	List<LuwaCuatro> listaFiltroLuwa();

	List<LuwaCuatro> listaPorFechaLuwa(Date fecha);

	void guardarLuwa(LuwaCuatro luwa);

	void actualizarLuwa(LuwaCuatro luwa);
