...
public interface IDafDosDao {

	List<DafDos> listaDaf();

	List<DafDos> listaFiltroDaf();

	List<DafDos> listaPorFechaDaf(Date fecha);
	
	void guardarDaf(DafDos daf);

	void actualizarDaf(DafDos daf);
