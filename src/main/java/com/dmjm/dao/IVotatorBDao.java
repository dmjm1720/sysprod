...
public interface IVotatorBDao {
	List<VotatorB> listaVotator();

	List<VotatorB> listaFiltroVotator();

	List<VotatorB> listaPorFechaVotator(Date fecha);

	void guardarVotator(VotatorB votator);

	void actualizarVotator(VotatorB votator);
