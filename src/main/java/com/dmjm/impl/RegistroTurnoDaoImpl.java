...
public class RegistroTurnoDaoImpl implements IRegistroTurnosDao {
	...
	@Override
	public List<RegistroTurnos> listaRegistroTurnosVotatorA(Date fecha) {
		List<RegistroTurnos> lista = null;
	    Transaction t = null;
	    ...
	    try (Session session = HibernateUtil.getSessionFactory().openSession()) {
	        ...
	        String hql = "FROM RegistroTurnos WHERE fecha = :fecha AND descProceso = 'VOTATOR PLANTA A'";
			Query<RegistroTurnos> query = session.createQuery(hql, RegistroTurnos.class);
	        query.setParameter("fecha", fecha);
	...
	@Override
	public List<RegistroTurnos> listaRegistroTurnosVotatorB(Date fecha) {
		List<RegistroTurnos> lista = null;
	    Transaction t = null;
	    ...
	    try (Session session = HibernateUtil.getSessionFactory().openSession()) {
	        ...
	        String hql = "FROM RegistroTurnos WHERE fecha = :fecha AND descProceso = 'VOTATOR PLANTA B'";
			Query<RegistroTurnos> query = session.createQuery(hql, RegistroTurnos.class);
	        query.setParameter("fecha", fecha);
	...
	@Override
	public List<RegistroTurnos> listaRegistroTurnosDafUno(Date fecha) {
		List<RegistroTurnos> lista = null;
	    Transaction t = null;
	    ...
	    try (Session session = HibernateUtil.getSessionFactory().openSession()) {
	        ...
	        String hql = "FROM RegistroTurnos WHERE fecha = :fecha AND descProceso = 'DAF UNO'";
			Query<RegistroTurnos> query = session.createQuery(hql, RegistroTurnos.class);
	        query.setParameter("fecha", fecha);
	...
	@Override
	public List<RegistroTurnos> listaRegistroTurnosDafDos(Date fecha) {
		List<RegistroTurnos> lista = null;
	    Transaction t = null;
	    ...
	    try (Session session = HibernateUtil.getSessionFactory().openSession()) {
	        ...
	        String hql = "FROM RegistroTurnos WHERE fecha = :fecha AND descProceso = 'DAF DOS'";
			Query<RegistroTurnos> query = session.createQuery(hql, RegistroTurnos.class);
	        query.setParameter("fecha", fecha);
	...
	@Override
	public List<RegistroTurnos> listaRegistroTurnosSecadorA(Date fecha) {
		List<RegistroTurnos> lista = null;
	    Transaction t = null;
	    ...
	    try (Session session = HibernateUtil.getSessionFactory().openSession()) {
	        ...
	        String hql = "FROM RegistroTurnos WHERE fecha = :fecha AND descProceso = 'SECADOR A'";
			Query<RegistroTurnos> query = session.createQuery(hql, RegistroTurnos.class);
	        query.setParameter("fecha", fecha);
	...
	@Override
	public List<RegistroTurnos> listaRegistroTurnosSecadorB(Date fecha) {
		List<RegistroTurnos> lista = null;
	    Transaction t = null;
	    ...
	    try (Session session = HibernateUtil.getSessionFactory().openSession()) {
	        ...
	        String hql = "FROM RegistroTurnos WHERE fecha = :fecha AND descProceso = 'SECADOR B'";
			Query<RegistroTurnos> query = session.createQuery(hql, RegistroTurnos.class);
	        query.setParameter("fecha", fecha);
